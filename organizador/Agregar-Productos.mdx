...
<Steps>
    ...
    <Frame>
        <img src = "../images/MenuProductos.png" alt = "Imagen del sidebar menu"/>
    </Frame>
    ...
    <Frame>
        <img src = "../images/NuevoProductoBoton.png" alt = "Imagen de boton de Nuevo Producto "/>
    </Frame>
    ...
    <Step title="Hacer click sobre el botón 'Agregar Variante'">
      ...
      <Frame>
        <img src = "../images/AgregarVariante.png" alt = "Imagen del boton de agregar variante"/>
      </Frame>
    ...
    <Frame>
        <img src = "../images/CrearBotonProducto.png" alt = "Imagen del boton de crear producto"/>
    </Frame>
...
#### ¿Cómo asignar productos a Eventos?
    <Steps>
        ...
        <Frame>
            <img src = "../images/Productoimg.png" alt = "Imagen de producto" />
        </Frame>
        ...
        <Frame>
            <img src = "../images/AsignarPrd.png" alt = "Imagen de producto" />
        </Frame>
